# terraform-aws-s3-suppressed

[![Build Status](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed/workflows/Verify/badge.svg?branch=main)](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed)
[![Latest Release](https://img.shields.io/github/release/JamesWoolfenden/terraform-aws-s3-suppressed.svg)](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed/releases/latest)
[![GitHub tag (latest SemVer)](https://img.shields.io/github/tag/JamesWoolfenden/terraform-aws-s3-suppressed.svg?label=latest)](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed/releases/latest)
...
File a GitHub [issue](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed/issues).

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/JamesWoolfenden/terraform-aws-s3-suppressed/issues) to report any bugs or file feature requests.
